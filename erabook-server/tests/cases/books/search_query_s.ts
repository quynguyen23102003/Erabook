...
export default function () {
	describe("/books/search?s=test book 1 updated - with search query", function () {
		it("Should return 1 book entry", function (done) {
			fetch("http://localhost:3000/books/search?s=test book 1 updated", {
				method: "GET",
				headers: {
